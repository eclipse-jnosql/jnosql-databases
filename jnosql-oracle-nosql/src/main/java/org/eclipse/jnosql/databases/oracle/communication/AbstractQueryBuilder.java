...
abstract class AbstractQueryBuilder implements Supplier<OracleQuery> {
    ...
    protected void condition(CriteriaCondition condition, StringBuilder query, List<FieldValue> params,
        ...
        switch (condition.condition()) {
            ...
            case NOT: {
                ...
                if (negated.condition() == Condition.EQUALS
                        && negated.element().value().isNull()) {
    ...
    private void predicateRegex(StringBuilder query, List<FieldValue> params, String name, Object value) {
        ...
        params.add(FieldValueConverter.of(value));
    }
    ...
    private String relationalIdentifierOf(String name) {
        String identifier = validateIdentifier(name);
    ...
    protected FieldValue entityCondition(StringBuilder query, String tableName) {
        ...
        return FieldValueConverter.of(tableName);
    }
}
