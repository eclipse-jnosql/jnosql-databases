...
/**
 * Annotation used to define a dynamic CQL query method in {@link ScyllaDBRepository}.
 * Methods annotated with {@code @CQL} allow the execution of custom ScyllaDB Query Language (CQL) statements
