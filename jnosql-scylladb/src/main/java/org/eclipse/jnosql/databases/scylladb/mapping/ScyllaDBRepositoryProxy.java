...
class ScyllaDBRepositoryProxy<T, K> extends AbstractSemiStructuredRepositoryProxy<T, K> {

    private final Class<T> typeClass;

    private final ScyllaDBTemplate template;
    ...
    ScyllaDBRepositoryProxy(ScyllaDBTemplate template, Class<?> repositoryType,
