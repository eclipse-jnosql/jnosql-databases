...
/**
 * A ScyllaDB-specific extension of {@link ColumnTemplate}, providing additional functionality for interacting
 * with a ScyllaDB database using CQL queries and different consistency levels.
 */
public interface ScyllaDBTemplate extends ColumnTemplate {
     ...
     * @param level the ScyllaDB consistency level to use for the operation; must not be {@code null}
    ...
    /**
     * Executes a {@link SimpleStatement} in ScyllaDB.
     *
     * @param <T>       the type of the result
