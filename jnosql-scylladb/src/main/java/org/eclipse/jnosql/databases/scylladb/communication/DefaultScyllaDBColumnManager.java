...
class DefaultScyllaDBColumnManager implements ScyllaDBColumnManager {

    private final CqlSession session;

    private final String keyspace;

    DefaultScyllaDBColumnManager(CqlSession session, String keyspace) {
    ...
    @Override
    public ScyllaDBPreparedStatement nativeQueryPrepare(String query) {
        requireNonNull(query, "query is required");
        final PreparedStatement prepare = session.prepare(query);
        return new ScyllaDBPreparedStatement(prepare, session);
    }
    ...
    public String toString() {
        return "DefaultScyllaDBColumnManager{" +
                "session=" + session +
                ", keyspace='" + keyspace + '\'' +
                '}';
    }
