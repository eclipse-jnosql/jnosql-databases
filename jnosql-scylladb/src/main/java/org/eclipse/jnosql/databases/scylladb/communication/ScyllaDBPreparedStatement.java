 ...
 */
public class ScyllaDBPreparedStatement {
    ...
    /**
     * Constructs a new ScyllaDBPreparedStatement.
     *
     * @param prepare the underlying ScyllaDB PreparedStatement
     * @param session the CQL session
     */
    ScyllaDBPreparedStatement(com.datastax.oss.driver.api.core.cql.PreparedStatement prepare, CqlSession session) {
     ...
     * @return this ScyllaDBPreparedStatement instance
     */
    public ScyllaDBPreparedStatement bind(Object... values) {
    ...
    /**
     * Returns a string representation of this ScyllaDBPreparedStatement.
     *
     * @return a string representation of this ScyllaDBPreparedStatement
     */
    @Override
