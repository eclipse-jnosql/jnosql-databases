...
import org.eclipse.jnosql.databases.scylladb.communication.UDT;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Actor;
import org.eclipse.jnosql.databases.scylladb.mapping.model.AppointmentBook;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Artist;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Director;
import org.eclipse.jnosql.databases.scylladb.mapping.model.History2;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Job;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Money;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Movie;
import org.eclipse.jnosql.databases.scylladb.mapping.model.Worker;
...
public class ScyllaDBColumnEntityConverterTest {
    ...
    public void shouldSupportUDT() {
        ...
        assertThat(entity.name()).isEqualTo("ContactScyllaDB");
    ...
    public void shouldSupportUDTToEntity() {
        var entity = CommunicationEntity.of("ContactScyllaDB");
        ...
        ContactScyllaDB contact = converter.toEntity(entity);
    ...
    public void shouldConvertListUDT() {
        ...
        appointmentBook.setContacts(asList(new org.eclipse.jnosql.databases.scylladb.mapping.model.Contact("Poliana", "poliana@santana.com"),
                new org.eclipse.jnosql.databases.scylladb.mapping.model.Contact("Ada", "ada@lovelace.com")));
    ...
    public void shouldConvertListUDTToEntity() {
        ...
        List<org.eclipse.jnosql.databases.scylladb.mapping.model.Contact> contacts = appointmentBook.getContacts();
        assertThat(appointmentBook.getUser()).isEqualTo("otaviojava");

        assertThat(contacts).contains(new org.eclipse.jnosql.databases.scylladb.mapping.model.Contact("Poliana", "poliana"),
                new org.eclipse.jnosql.databases.scylladb.mapping.model.Contact("Ada", "ada@lovelace.com"));
