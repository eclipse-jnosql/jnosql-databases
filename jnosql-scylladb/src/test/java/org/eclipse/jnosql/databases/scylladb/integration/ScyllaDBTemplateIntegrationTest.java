 ...
 *   Otavio Santana
 */
package org.eclipse.jnosql.databases.scylladb.integration;


import jakarta.inject.Inject;
import org.eclipse.jnosql.communication.driver.ConfigurationReader;
import org.eclipse.jnosql.databases.scylladb.communication.ScyllaDBConfigurations;
import org.eclipse.jnosql.databases.scylladb.communication.ColumnDatabase;
import org.eclipse.jnosql.databases.scylladb.mapping.ScyllaDBTemplate;
...
@AddPackages(ScyllaDBTemplate.class)
@AddExtensions({ReflectionEntityMetadataExtension.class,
        ColumnExtension.class})
@AddPackages(Reflections.class)
@AddPackages(Converters.class)
@EnabledIfSystemProperty(named = NAMED, matches = MATCHES)
class ScyllaDBTemplateIntegrationTest {
    ...
    static {
        ...
        System.setProperty(ScyllaDBConfigurations.HOST.get()+".1", ColumnDatabase.INSTANCE.host());
        System.setProperty(ScyllaDBConfigurations.PORT.get(), Integer.toString(ColumnDatabase.INSTANCE.port()));
    }
