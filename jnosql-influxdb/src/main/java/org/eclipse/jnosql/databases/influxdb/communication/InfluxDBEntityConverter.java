...
final class InfluxDBEntityConverter {
    ...
    static Instant toInstant(Object value) {
        ...
        return switch (converted) {
            ...
            case null -> throw new IllegalArgumentException("InfluxDB identifier cannot be null");
    ...
    private static void addField(Point point, Element element) {
        ...
        switch (value) {
            case Boolean booleanValue -> point.setField(element.name(), booleanValue);
            case Number number -> point.setField(element.name(), number);
            case Character character -> point.setField(element.name(), character.toString());
            case CharSequence sequence -> point.setField(element.name(), sequence.toString());
            default -> throw new IllegalArgumentException(
