...
@DisplayName("Solr Template integration")
class SolrTemplateIntegrationTest {
    ...
    @Nested
    @DisplayName("When inserting entities with the Solr template")
    class WhenInsertingWithSolrTemplate {
    ...
    @Nested
    @DisplayName("When updating entities with the Solr template")
    class WhenUpdatingWithSolrTemplate {
        ...
        @Test
        @DisplayName("Should update a magazine with null field values")
    ...
    @Nested
    @DisplayName("When finding entities with the Solr template")
    class WhenFindingWithSolrTemplate {
    ...
    @Nested
    @DisplayName("When deleting entities with the Solr template")
    class WhenDeletingWithSolrTemplate {
